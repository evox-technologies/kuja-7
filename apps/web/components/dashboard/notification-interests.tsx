    ...
    <Popover onOpenChange={handleOpenChange}>
      <PopoverTrigger asChild>
        <button className="relative p-2 rounded-full hover:bg-gray-50 transition-colors hidden sm:block">
          ...
          {unreadCount > 0 && (
            <span className="absolute top-1.5 right-1.5 min-w-[14px] h-3.5 px-1 bg-brand rounded-full text-[9px] font-semibold flex items-center justify-center text-on-brand">
