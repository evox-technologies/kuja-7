...
export default function DashboardTabs() {
  ...
  return (
    <div className="bg-white border-b border-gray-100 shrink-0">
      <div className="mx-auto max-w-6xl px-2 sm:px-6 grid grid-cols-4">
        {TABS.map(({ label, href, icon: Icon, protected: isProtected }) => {
          ...
          return (
            <button
              ...
              className={cn(
                'flex items-center justify-center gap-1.5 px-2 sm:px-4 py-3 sm:py-4 text-xs sm:text-sm font-medium border-b-2 transition-colors whitespace-nowrap min-w-0',
                active
