...
export default function ConversationList({ selectedId, onSelect, currentUserId, autoSelectId }: Props) {
  ...
  return (
    <div className="shrink-0 bg-white border-r border-gray-100 flex flex-col w-full lg:w-72 h-full">
      {/* Header */}
      <div className="p-4 border-b border-gray-100">
        ...
        <div className="relative">
          ...
          <input
            ...
            className="w-full pl-9 pr-3 py-2 text-sm bg-gray-50 border border-gray-100 rounded-full focus:outline-none focus:ring-2 focus:ring-brand-border"
              ...
              filteredConversations.map((c) => (
                <button
                  ...
                  className={cn(
                    ...
                    selectedId === c.id ? 'bg-brand-light' : 'hover:bg-gray-50'
                  )}
                >
